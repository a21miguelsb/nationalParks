...
class __TwigTemplate_46b4bcdffa81c7c7aa7946773c2f9abd extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["parque"]) {
            ...
            echo "</a></td>
                    <td><a href=";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show_ecosistema", ["ecosistema" => twig_get_attribute($this->env, $this->source, $context["parque"], "ecosistema", [], "any", false, false, false, 22)]), "html", null, true);
            echo ">";
...
";
    ...
    {
        return array (  131 => 26,  122 => 23,  116 => 22,  110 => 21,  107 => 20,  103 => 19,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
        ...
        <table class=\"table table-primary\">
            ...
            <tbody>
                ...
                <tr class=\"text-center m-2\">
                    ...
                    <td><a href={{ path('show_ecosistema', {ecosistema:parque.ecosistema} ) }}>{{parque.ecosistema}}</a></td>
